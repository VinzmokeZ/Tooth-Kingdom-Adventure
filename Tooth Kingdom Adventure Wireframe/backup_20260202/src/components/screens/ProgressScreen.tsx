...
export function ProgressScreen({ navigateTo, userData }: ScreenProps) {
  const weeklyData = [
    { day: 'M', value: 80, completed: true },
    { day: 'T', value: 100, completed: true },
    { day: 'W', value: 90, completed: true },
    { day: 'T', value: 95, completed: true },
    { day: 'F', value: 100, completed: true },
    { day: 'S', value: 85, completed: true },
    { day: 'S', value: 100, completed: true },
  ];
            ...
            {weeklyData.map((day, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2">
                ...
                <span className={`text-xs font-medium ${
                  day.completed ? 'text-purple-600' : 'text-gray-400'
                }`}>
                  {day.day}
                </span>
              </div>
