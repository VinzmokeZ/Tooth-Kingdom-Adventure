...
export function CalendarScreen({ navigateTo, userData }: ScreenProps) {
  ...
  const startDay = 2; // Starts on Wednesday
  const completedDays = [1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 15, 16, 17, 18, 19, 22, 23];
  const currentDay = 23;
    ...
    <div className="h-full bg-gradient-to-b from-green-50 to-white flex flex-col">
      ...
      <div className="sticky top-0 bg-white border-b border-gray-100 px-5 py-4 z-10 shadow-sm">
        ...
        <div className="flex items-center justify-between bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl px-4 py-3 text-white">
          ...
          <span className="font-bold text-lg">January 2026</span>
          <button className="p-1">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-md">
          ...
          <div className="space-y-3">
            {[
              { date: 'Today, Jan 23', activity: 'Morning brushing completed', time: '8:30 AM', completed: true },
              { date: 'Yesterday, Jan 22', activity: 'Evening brushing completed', time: '9:15 PM', completed: true },
              { date: 'Jan 22', activity: 'Morning brushing completed', time: '8:15 AM', completed: true },
              { date: 'Jan 21', activity: 'Both sessions completed', time: '9:00 PM', completed: true },
            ].map((item, i) => (
              <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900 text-sm">{item.activity}</h4>
