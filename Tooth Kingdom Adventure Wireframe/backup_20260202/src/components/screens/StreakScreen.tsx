...
export function StreakScreen({ navigateTo, userData }: ScreenProps) {
  const weekDays = [
    { day: 'Mon', date: 17, completed: true },
    { day: 'Tue', date: 18, completed: true },
    { day: 'Wed', date: 19, completed: true },
    { day: 'Thu', date: 20, completed: true },
    { day: 'Fri', date: 21, completed: true },
    { day: 'Sat', date: 22, completed: true },
    { day: 'Sun', date: 23, completed: true },
  ];

  const streakHistory = [30, 50, 70, 60, 80, 75, 90, 100, 85, 95, 88, 92];
    ...
    <div className="h-full bg-gradient-to-b from-orange-50 to-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { icon: Trophy, label: 'Best Streak', value: '23 days', color: 'from-amber-400 to-orange-500' },
