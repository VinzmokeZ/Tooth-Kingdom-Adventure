...
export default function App() {
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light" forcedTheme="light" enableSystem={false}>
      <div className={isNative ? "w-full h-full min-h-[100dvh]" : "min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-pink-100 flex items-center justify-center p-4 sm:p-8 transition-colors duration-500"}>
        <AuthProvider>
          <GameProvider>
            <PhoneFrame>
              <AppContent />
