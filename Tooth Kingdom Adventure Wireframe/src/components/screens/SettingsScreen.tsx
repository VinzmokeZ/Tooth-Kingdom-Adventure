...
export function SettingsScreen({ navigateTo }: ScreenProps) {
  ...
  return (
    <div className="h-full bg-gradient-to-b from-purple-50 to-white flex flex-col relative overflow-hidden">
      <AnimatedBackground />
      <div className="sticky top-0 bg-white/80 border-b border-gray-100 px-5 py-4 z-20 flex items-center gap-3 backdrop-blur-md transition-colors relative">
        <button onClick={handleBack} className="p-2 -ml-2 rounded-full hover:bg-gray-100 transition-all"><ChevronLeft className="w-6 h-6 text-gray-700" /></button>
