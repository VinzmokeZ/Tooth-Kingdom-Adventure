...
export function SignInScreen({ navigateTo }: ScreenProps) {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-purple-100 via-pink-50 to-cyan-50 dark:from-gray-900 dark:via-purple-950 dark:to-black diff-base flex flex-col overflow-y-auto relative transition-colors duration-500">
      <AnimatedBackground />
