  ...
  return (
    <div className="h-full bg-gradient-to-b from-purple-50 to-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
        ...
        {/* Share profile */}
        <button
          onClick={() => alert(`Sharing progress: I have earned ${userData.totalStars} stars and reached Level ${userData.level} in Tooth Kingdom! 🦷⭐`)}
          className="w-full h-14 bg-white border-2 border-purple-600 text-purple-600 rounded-2xl font-bold shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 mb-4 hover:bg-purple-50"
        >
